...
func NewGRPCServer(config *Config, grpcOpts ...grpc.ServerOption) (*grpc.Server, error) {
	...
	trace.ApplyConfig(trace.Config{DefaultSampler: func(p trace.SamplingParameters) trace.SamplingDecision {
		...
		return trace.ProbabilitySampler(0.5)(p)
	}})
	err := view.Register(ocgrpc.DefaultServerViews...) // default view collects request/response bytes, latency and finished rpc
	if err != nil {
		return nil, err
	}
